  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-lg text-stone-100 mb-6">
        ...
        <p className="text-md text-stone-200 italic mb-10">
          {capabilitiesSummary}
        </p>
        <p className="text-sm text-stone-300 italic mb-10">{navigationDescription}</p>
      </div>
